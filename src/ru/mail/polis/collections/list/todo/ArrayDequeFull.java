...
public class ArrayDequeFull<E> extends ArrayDequeSimple<E> implements Deque<E> {
    ...
    public <T> T[] toArray(T[] a) {
        if (head <= tail) {
            ...
            System.arraycopy(array, head, a, 0, size - head);
            System.arraycopy(array, 0, a, size - head, tail + 1);
        }
        return a;
    }
    ...
    public Iterator<E> descendingIterator() {
        return new Iterator<E>() {
            private int tail = ArrayDequeFull.this.tail;
            ...
            public E next() {
                ...
                return (E) array[(tail - lastNextIndex + capacity) % capacity];
            }
            ...
            public void remove() {
                ...
                removeElement((tail - lastNextIndex + capacity) % capacity);
                lastNextIndex = -1;
            }
        };
    }
